...
class Job:
    def __init__(self, parameters):
        ...
        # Opt-in low-overhead simulation path. None means "not requested for
        # this test", and TestCase then falls back to the BOPTEST_FAST
        # environment variable, so that a deployment can turn it on for every
        # test without the client asking.
