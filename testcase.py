...
class TestCase(object):
    ...
    def initialize(self, start_time, warmup_period, end_time=np.inf,
        ...
        warmup_interval: int or float, optional
            ...
            Default is None, which warms up on that same 30 s grid and so
            reproduces the behaviour of earlier versions.
    ...
    def get_kpis(self, names=None):
        ...
        names: list of str, optional
            ...
            and left out of the payload.  Requesting a subset does not affect
            the value any KPI reports later.
